export const sessionMessages = {
  ...
  "session.pruning.not_deletable": "Это содержимое нельзя удалить. Можно удалять только завершённые инструменты и рассуждения этой сессии.",
  "session.pruning.unsupported_storage": "Плагин очистки не смог проверить хранилище этой сессии. В очистке отказано.",
