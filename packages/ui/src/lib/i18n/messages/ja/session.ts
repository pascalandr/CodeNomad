export const sessionMessages = {
  ...
  "sessionList.status.interrupted": "中断",
  ...
  "sessionList.loadError.detail": "OpenCode からセッション一覧が返されませんでした。",
  "sessionList.loadError.retry": "再試行",
  ...
  "sessionPreview.title": "Web プレビュー",
  ...
  "sessionPreview.comment.mode": "コメントモード",
  "sessionPreview.comment.title": "プレビューコメントを追加",
  "sessionPreview.comment.prompt": "選択した要素で変更すべき内容を説明してください。",
  "sessionPreview.comment.label": "コメント",
  "sessionPreview.comment.add": "コメントを追加",
  "sessionPreview.comment.cancel": "キャンセル",
  "browserFrame.viewport": "ビューポートサイズ",
  "browserFrame.viewport.responsive": "レスポンシブビューポート",
  "browserFrame.viewport.desktop": "デスクトップビューポート (1440 x 900)",
  "browserFrame.viewport.tablet": "タブレットビューポート (768 x 1024)",
  "browserFrame.viewport.tabletLandscape": "タブレット横向き (1024 x 768)",
  "browserFrame.viewport.mobile": "モバイルビューポート (390 x 844)",
